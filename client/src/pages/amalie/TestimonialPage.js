...
function TestimonialPage() {
      ...
      const handleSubmit = async () => {
            const newTestimonialData = {
                  ...
                  rating: value, // Using the rating selected by the user
                  user_id: 1, // Assuming you are setting a static user ID, replace this with the actual user ID
            };
            ...
            try {
                  ...
                  setNewTestimonial({ title: "", feedback: "", rating: 0 });
                              ...
                              <div className="p-4">
                                    <div className="grid grid-cols-3 gap-4">
                                          {testimonials.map((testimonial) => (
                                                <TestimonialCard
                                                      key={testimonial.id} // Ensure `testimonial.id` is unique and stable
