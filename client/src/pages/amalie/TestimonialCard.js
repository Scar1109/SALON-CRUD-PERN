...
function TestimonialCard({ testimonial, onDelete, onUpdate }) {
      ...
      const handleUpdate = async () => {
            try {
                  await axios.put(
                        `http://localhost:3001/api/testimonials/${testimonial.id}`,
                        {
                              rating: value,
                              title,
                              description,
                  ...
                  <div className="flex-1 ml-1 mt-2">
                        <div className="flex flex-row ml-[-7]">
                              ...
                              <div className="flex flex-col">
                                    ...
                                    <p className="ml-3 mb-2">{formattedDate}</p>
                              </div>
